...
import { useSnake, useDisplay, COLS, ROWS, CELL_PX, TICK_MS, type Direction } from './store'
...
const { tick, setDir, start, pause } = useSnake.getState()
    ...
    <div style={styles.root}>
      ...
      {status !== 'running' && (
        <div style={styles.overlay}>
          ...
          {status === 'paused' && (
            <div style={styles.pauseMsg}>PAUSED</div>
          )}
          <button
            style={styles.btn}
...
const styles = {
  ...
  overlay: {
    ...
    alignItems:     'center',
    gap:            16,
    // vertically centred over the grid via the parent's relative positioning
    inset:          0,
    justifyContent: 'center',
  },
  gameOver: {
